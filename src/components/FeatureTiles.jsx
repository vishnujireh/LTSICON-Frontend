      ...
      <div className="mx-auto">
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="flex min-h-[480px] flex-col items-center overflow-hidden rounded-[16px] border border-[#E7D9BB] bg-[#F4ECD9] px-8 pb-0 pt-12 text-center">
            ...
            <p className="mx-auto mb-4 max-w-[460px] text-[1.05rem] text-[#6E5C54]">Robotic surgery, Microsurgery, Endo Hepatology, International Radiology, POCUS, Pathology & Hemodynamic Monitoring and more.</p>
